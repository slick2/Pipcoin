...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("PipCoins"));
    case mBTC: return QString(QObject::tr("Milli-PipCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-PipCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
