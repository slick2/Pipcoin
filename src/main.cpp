...
unsigned int nStakeMinAge = 4 * nOneHour; // 4 hours as zero time weight
...
const string strMessageMagic = "PipCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PipCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // PipCoin: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    int64_t nMaxOffset = 12 * 86400; // 12 days
    ...
    // Don't accept blocks with future timestamps
     if (pindexPrev->nHeight > 70000 && nMedianTimePast  + nMaxOffset < GetBlockTime())
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PipCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PipCoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1475680100;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1475680111;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 388283; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x79e7820af09bef3ca10db43834e1c39d2e122ba1e63f3278738b6b77a8c1a976"));
...
unsigned char pchMessageStart[4] = { 0x96, 0xf4, 0xea, 0xb5 };
